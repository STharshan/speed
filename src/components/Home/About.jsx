...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Got recommended to go here by a friend as I was having issues with my Alfa 159. Took the car in and left it with full confidence, he did a full diagnosis on the car to find any other underlying issues, kept in contact with me letting me know what he found, how the issues were sorted etc.",
    name: "Will Hope",
  },
